...
def get_shis(
    ...
    Args:
        ...
        strict: If True, raise :class:`~relucent.core.errors.ShiProofError` on invalid proofs.
    ...
    Raises:
        ...
        :class:`~relucent.core.errors.ShiProofError`: If ``strict`` is True and a candidate facet proof fails.
    """
    if tol is None:
