...
def discover_boundary_complex(
    ...
    **kwargs: Any,
    ...
    with :func:`~relucent.search.exploration.finalize_boundary_complex` (ambient coface
    SHIs, dual graph, genericity, and :func:`~relucent.verify.certify.certify_complex`).
